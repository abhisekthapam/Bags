        ...
        <div className="w-full h-full flex justify-center items-center ">
          ...
          <IoClose onClick={closeModal} className="cursor-pointer absolute top-[15%] right-[1%] text-2xl z-[70]" title="Close"/>
            ...
            <div className="w-full h-[60vh] p-10 py-5">
              ...
              <p className="mb-4 text-xl font-semibold">Amount: <span className="font-light text-lg"> Rs.{product.price}</span></p>
              ...
              <p className="mb-4 text-xl font-semibold">Discount: <span className="font-light text-lg"> Rs.{product.discount}</span></p>
            </div>
